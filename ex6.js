...
console.log("El area de un círculo de radio", radio, "es de", numeroPi*radio*radio, "m2")
 ...
 */
console.log("El area de un círculo de radio", radio, "es de", Math.round(numeroPi*radio*radio*100)/100, "m2");